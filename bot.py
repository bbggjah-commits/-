...
class TelegramBot:
    def __init__(self):
        ...
        # كلمات التشفير بأنماط محددة - أضفت أنماط التشفير المطلوبة
        self.encryption_patterns = {
            # الكلمات الأساسية بأنماط التشفير المطلوبة
            'بيع': 'بيـ،ـع', 'شراء': 'شـ،،ـراء', 'مقابل': 'مقابـ،ـل', 
            'تبديل': 'تبـ،ـديل', 'كردت': 'كـ،ـردت',
            'عروض': 'عـ،ـروض', 'سعر': 'سـ،ـعر', 'متوفر': 'متوفـ،ـر',
            'متجر': 'متـ،ــجر', 'كمية': 'كمـ،ـية', 'كميه': 'كمـ،ـية',
            'حساب': 'حسـ،ـاب', 'مطلوب': 'مطلـ،ـوب', 'تجار': 'تجـ،ـار',
            'دفع': 'دفـ،ـع',
            
            # المشتقات بأنماط مختلفة
            'يبيع': 'يبـ،ـيع', 'تبيع': 'تبـ،ـيع', 'بائع': 'بـ،ـائع', 'مبيع': 'مبـ،ـيع',
            'يشترى': 'يشـ،ـترى', 'يشتري': 'يشـ،ـتري', 'مشتري': 'مشـ،ـتري', 'شراءات': 'شـ،ـراءات',
            'يعرض': 'يعـ،ـرض', 'العروض': 'العـ،ـروض', 'عروضات': 'عـ،ـروضات',
            'اسعار': 'أسـ،ـعار', 'أسعار': 'أسـ،ـعار', 'سعرها': 'سـ،ـعرها',
            'التجار': 'التجـ،ـار', 'تجاري': 'تجـ،ـاري', 'متجري': 'متـ،ـجري',
            'يدفع': 'يدفـ،ـع', 'ادفع': 'ادفـ،ـع', 'مدفوع': 'مدفـ،ـوع'
        }
    ...
    def encrypt_text(self, text):
        """تشفير النص الكامل بأنماط محددة"""
        encrypted_text = text
        
        # استبدال كل كلمة بنمط التشفير المحدد لها
        for word, encrypted_pattern in self.encryption_patterns.items():
            # استبدال بجميع الاحتمالات (حساس وغير حساس للحالة)
            encrypted_text = encrypted_text.replace(word, encrypted_pattern)
            encrypted_text = encrypted_text.replace(word.upper(), encrypted_pattern)
            encrypted_text = encrypted_text.replace(word.capitalize(), encrypted_pattern)
...
• تشفير ذكي بأنماط محددة

📝 <b>الكلمات المشفرة بأنماطها:</b>
• <code>بيـ،ـع – شـ،،ـراء – مقابـ،ـل – تبـ،ـديل - كـ،ـردت</code>
• <code>عـ،ـروض – سـ،ـعر – متوفـ،ـر - متـ،ــجر - كمـ،ـية</code>
• <code>حسـ،ـاب – مطلـ،ـوب - تجـ،ـار- دفـ،ـع</code>
...
🎯 <b>أنماط التشفير المستخدمة:</b>
<code>بيـ،ـع – شـ،،ـراء – مقابـ،ـل – تبـ،ـديل - كـ،ـردت</code>
<code>عـ،ـروض – سـ،ـعر – متوفـ،ـر - متـ،ــجر - كمـ،ـية</code>
<code>حسـ،ـاب – مطلـ،ـوب - تجـ،ـار- دفـ،ـع</code>

<b>مثال:</b>
<code>أريد بيع هاتف بسعر جيد في المتجر</code>

<b>ستصبح:</b>
<code>أريد بيـ،ـيع هاتف بسـ،ـعر جيد في المتـ،ــجر</code>
...
🎯 <b>تم تشفير الكلمات بأنماط محددة</b>
...
🔧 <b>للمسح:</b> اكتب <code>~امسح~</code>"""
    ...
    def run(self):
        ...
        print("🚀 بدأ تشغيل بوت التشفير مع أنماط التشفير الجديدة...")
